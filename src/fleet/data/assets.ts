...
export const ASSET_SEEDS: AssetSeed[] = [
  ...
  },
  {
    ...
    name: "Armored 01",
    kind: "ugv_armored",
    position: parked(depot, 8),
    headingDeg: 135,
    energyPct: 96,
    hoursSinceService: 18.2,
    workOrders: [],
    tags: ["armed", "armor", "cannon"],
    homeDepotId: "depot-alpha",
  },
  {
    id: "grizzly-02",
    ...
    name: "Armored 02",
    kind: "ugv_armored",
    position: parked(depot, 9),
    headingDeg: 135,
    energyPct: 82,
    hoursSinceService: 64.9,
    workOrders: [],
    tags: ["armed", "armor", "cannon"],
    homeDepotId: "depot-alpha",
  },
  {
    ...
    name: "Armed quad 01",
    kind: "uav_armed",
    position: parked(depot, 10),
    headingDeg: 270,
    energyPct: 94,
    hoursSinceService: 9.4,
    workOrders: [],
    tags: ["armed", "munitions", "isr"],
    homeDepotId: "depot-alpha",
  },
];
